    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0c0c0b] px-6 text-white">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-3xl border border-white/8 bg-[#141413] p-8">
          ...
          <p className="mb-7 text-sm text-white/40">Choose a new password to continue.</p>
          {token ? <ResetPasswordForm token={token} /> : <p className="text-sm text-red-300">Missing reset token.</p>}
        </div>
      </div>
    </div>
  );
