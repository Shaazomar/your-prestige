...
export function SizeChip({ size, dark = false, index = 0, className }: SizeChipProps) {
  return (
    <motion.span
      ...
      className={cn(
        "inline-flex items-center gap-1.5 rounded-full border px-4 py-1.5 text-xs font-medium tracking-wide shadow-soft transition-all duration-300 hover:-translate-y-0.5",
        dark
